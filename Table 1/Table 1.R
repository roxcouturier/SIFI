...
# write.csv(random_flip_PFS, file = paste0(chemin_fichier,"random_flip_PFS.csv"), row.names = FALSE)

random_flip_PFS <- read_csv("./Tables/Table 1/random_flip_PFS.csv")
...
# write.csv(random_clone_PFS, file = paste0(chemin_fichier,"random_clone_PFS.csv"), row.names = FALSE)

random_clone_PFS <- read_csv("./Tables/Table 1/random_clone_PFS.csv")
...
# write.csv(random_remove_PFS, file = paste0(chemin_fichier,"random_remove_PFS.csv"), row.names = FALSE)

random_remove_PFS <- read_csv("./Tables/Table 1/random_remove_PFS.csv")
...
# write.csv(random_flip_OS, file = paste0(chemin_fichier,"random_flip_OS.csv"), row.names = FALSE)

random_flip_OS <- read_csv("Tables/Table 1/random_flip_OS.csv")
...
# write.csv(random_clone_OS, file = paste0(chemin_fichier,"random_clone_OS.csv"), row.names = FALSE)

random_clone_OS <- read_csv("Tables/Table 1/random_clone_OS.csv")
...
# write.csv(random_remove_OS, file = paste0(chemin_fichier,"random_remove_OS.csv"), row.names = FALSE)

random_remove_OS <- read_csv("Tables/Table 1/random_remove_OS.csv")
...
write.csv(Table1, "/Users/roxanecouturier/Desktop/SIFI/Table1.csv")
