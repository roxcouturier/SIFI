...
#####  n=40 ######
directory_path <- "./Tables/Table S3/SIFI_n_40_640/40"
...
directory_path <- "./Tables/Table S3/SIFI_n_40_640/80"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
#####  n=160 ######
directory_path <- "./Tables/Table S3/SIFI_n_40_640/160"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
#####  n=640 ######
directory_path <- "./Tables/Table S3/SIFI_n_40_640/640"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
Table$Methods <- c("H0 40  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H0 80  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H0 160  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H0 640 -Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete")
...
write.csv(Table, "/Users/roxanecouturier/Desktop/SIFI/TableS3.csv")
