...
directory_path <- "./Tables/Table 3/10/H0"
...
directory_path <- "./Tables/Table 3/10/H1"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
directory_path <- "./Tables/Table 3/40/H0"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
directory_path <- "./Tables/Table 3/40/H1"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
directory_path <- "./Tables/Table 3/80/H0"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
directory_path <- "./Tables/Table 3/80/H1"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
Table$Methods <- c("H0 10  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H0 40  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H0 80  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H1 10 -Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H1 40 - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
                   "H1 80 - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete")
...
write.csv(Table, "/Users/roxanecouturier/Desktop/SIFI/Tables/Table 3/Table3.csv")
