...
directory_path <- "./Tables/Table S5/contamination/H0"
...
directory_path <- "./Tables/Table S5/contamination/H1"
file_names <- list.files(directory_path, pattern = "\\.csv$")
...
Table$Methods <- c("H0  - Best Respondeurs","Worst Respondeurs",
                   "H1 - Best Respondeurs","Worst Respondeurs ")
...
write.csv(Table, "/Users/roxanecouturier/Desktop/SIFI/TableS5.csv")
