...
directory_path <- "./Tables/Table S2/Data"
...
Table$Methods <- c("H0 1b  - Best Clone","Best Flip","Best Delete","Worst Clone","Worst Flip","Worst Delete",
...
write.csv(Table, file = "/Users/roxanecouturier/Desktop/SIFI/TableS2.csv")
