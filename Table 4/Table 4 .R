...
H0_scenario1a_remove_random_66 <- read.csv2("H0_scenario1a_remove_random_66.csv", sep = ",")
H0_scenario1a_flip_random_66 <- read.csv2("H0_scenario1a_flip_random_66.csv")
H0_scenario1a_clone_random_66 <- read.csv2("H0_scenario1a_clone_random_66.csv")
...
###### H1_scenario1a_remove_random_66 #####
  ...
  H1_scenario1a_remove_random_66 <- read.csv2("H1_scenario1a_remove_random_66.csv", sep = ",")
...
###### H1_scenario1a_flip_random_66 #####
  H1_scenario1a_flip_random_66 <- read.csv2("H1_scenario1a_flip_random_66.csv")
...
##### H1_scenario1a_clone_random_66 ######
  H1_scenario1a_clone_random_66 <- read.csv2("H1_scenario1a_clone_random_66.csv")
  ...
  write.csv(Table, "/Users/roxanecouturier/Desktop/SIFI/Table4.csv")
